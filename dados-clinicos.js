...
//
// Segunda ampliação, 29/07/2026 — os pós-freudianos, a pedido do Montgomery:
// "quero todos os profissionais sim. Freud, Lacan, Roudinesco, Melanie Klein".
// 11 categorias novas: Klein, Lacan, Winnicott, Bion, Ferenczi, Anna Freud,
// Dolto, Jung, Kohut, Roudinesco e uma de orientação (As escolas em diálogo).
// ATENÇÃO À PROCEDÊNCIA: as categorias têm origens diferentes, e isso importa.
//
// COM FONTE NO ACERVO (conferidas contra o texto original):
//   - as categorias freudianas, contra 03_Biblioteca/Freud (obra completa Imago);
//   - "O silêncio na sessão", contra Nasio, "O silêncio na psicanálise" (Zahar
//     2010), em 03_Biblioteca/Psicanalise_Alem_de_Freud — resumo na mesma pasta;
//   - "Dicionário de psicanálise (Roudinesco & Plon)", contra o próprio
//     dicionário (Zahar 1998), na mesma pasta.
//   As três últimas entraram em 29/07/2026, vindas da estante do Kindle.
//
// SEM FONTE NO ACERVO (escritas do conhecimento da literatura psicanalítica):
//   Klein, Lacan, Winnicott, Bion, Ferenczi, Anna Freud, Dolto, Kohut e as
//   categorias de síntese. São seguras como mapa e como orientação de leitura,
//   mas não substituem a obra: quando ele adquirir os originais, vale conferir
//   e aprofundar contra o texto.
//
// Jung está declarado no próprio intro como psicologia analítica, NÃO
// psicanálise em sentido estrito. =====
const psicanaliseTemas = [
  ...
  {
    categoria:'Estruturas Clínicas — Neurose, Psicose e Perversão',
    intro:'A pergunta que vem antes do sintoma: com qual estrutura este sujeito responde à castração? Cada estrutura tem um mecanismo próprio e pede um manejo próprio. Não é rótulo nem gravidade — é o modo de funcionamento psíquico. Base: Compêndio da Psicanálise (1938) e a divisão clássica retomada por Lacan.',
    itens:[
      {nome:'Neurose — mecanismo: recalque',desc:'O sujeito aceitou a lei e a proibição, mas paga o preço: o desejo proibido é recalcado e retorna deformado como sintoma, sonho, ato falho. Sinais na escuta: dúvida, culpa, angústia, conflito interno, pergunta sobre o próprio desejo. A realidade permanece de pé. É a estrutura mais comum e a que melhor responde à interpretação — o neurótico sofre por saber demais e não poder dizer.'},
      {nome:'Psicose — mecanismo: forclusão',desc:'A lei paterna não chegou a se inscrever — não foi recalcada, foi rejeitada de origem. O que é forcluído no simbólico retorna no real: alucinação, delírio, certeza inabalável. Sinais na escuta: certeza no lugar da dúvida, linguagem tomada ao pé da letra, sensação de ser objeto do gozo do Outro. Manejo: não confrontar o delírio (que é tentativa de cura, não a doença) — fazer bordas, sustentar o laço, encaminhar para acompanhamento psiquiátrico conjunto.'},
      {nome:'Perversão — mecanismo: renegação',desc:'O sujeito sabe da castração e ao mesmo tempo não quer saber — sustenta as duas coisas ao mesmo tempo. A lei não é ignorada: é usada, contornada, transformada em cenário. Sinais na escuta: ausência de culpa e de dúvida, o outro reduzido a instrumento, o gozo posto como programa e não como sofrimento. Não confundir com prática sexual: perversão aqui é estrutura, não conteúdo erótico.'},
      {nome:'Histeria — o corpo que fala',desc:'Forma da neurose em que o conflito recalcado se inscreve no corpo: conversão, paralisia, dor sem lesão, cegueira histérica, globus. O sintoma é uma frase que não pôde ser dita e virou órgão. A pergunta da histeria é sobre o desejo do outro: o que eu sou para ele? Sinais: teatralidade e sedução involuntária, insatisfação estrutural (o objeto que chega deixa de servir), identificação com o sofrimento alheio. Ponte direta com a Conversão orgânica nos mecanismos de defesa.'},
      {nome:'Neurose obsessiva — o pensamento que aprisiona',desc:'Forma da neurose em que o conflito é mantido no pensamento, longe do corpo e do afeto. Rituais, rumina, dúvida infinita, controle, adiamento, ordem, avareza de tempo e de afeto. A pergunta da obsessão é sobre a própria existência: estou vivo ou morto? Sinais: isolamento e anulação retroativa como defesas principais, agressividade recalcada travestida de escrúpulo, procrastinar como forma de não desejar. O obsessivo mata o desejo para não perder o objeto.'},
      {nome:'Fobia — a angústia com endereço',desc:'Forma da neurose que dá nome e lugar a uma angústia que era flutuante e insuportável. O objeto fóbico (altura, avião, cachorro, multidão, sangue) funciona como pára-raios: concentra num ponto externo o que era terror difuso. Caso príncipe: o pequeno Hans. Clinicamente: nunca tratar só o objeto — perguntar o que a fobia protege o sujeito de encontrar, e o que ele evitaria fazer na vida se ela cedesse.'},
      {nome:'Diferencial na primeira escuta',desc:'Roteiro prático: (1) há dúvida ou há certeza? dúvida aponta neurose, certeza inabalável aponta psicose; (2) há culpa? culpa aponta neurose, ausência de culpa com o outro instrumentalizado aponta perversão; (3) a linguagem é metafórica ou literal? (4) o sofrimento está no corpo (histeria) ou no pensamento (obsessão)? (5) a realidade compartilhada está de pé? Nunca fechar estrutura numa sessão — é hipótese de trabalho que se confirma ao longo do tempo, e o encaminhamento psiquiátrico caminha junto sempre que houver risco.'}
    ]
  },
  {
    categoria:'Angústia, Medo e Pânico',
    intro:'Freud (1926 — Inibição, Sintoma e Angústia, vol. 20) reformula: não é o recalque que gera angústia; é a angústia que dispara o recalque. Ela é o sinal de alarme do Ego. Distinguir os tipos muda o manejo — e muda o que se trata primeiro.',
    itens:[
      {nome:'Angústia-sinal',desc:'Alarme disparado pelo Ego diante de um perigo interno que se anuncia — um desejo prestes a emergir. É pequena, antecipatória e útil: permite acionar a defesa antes do transbordo. Toda vez que o paciente diz que sentiu um aperto antes de algo acontecer, é a angústia-sinal trabalhando. Ela é aliada, não inimiga.'},
      {nome:'Angústia automática (traumática)',desc:'Quando o alarme falha e o aparelho psíquico é inundado de uma vez por excitação que não consegue ligar nem descarregar. É o estado de desamparo absoluto — protótipo: o nascimento e a perda da mãe. É o que se vê no ataque de pânico e na crise traumática: o sujeito não sabe do que tem medo, só que vai morrer. Aqui não se interpreta — primeiro se acolhe, se respira, se restabelece o corpo.'},
      {nome:'Medo, angústia e susto',desc:'Freud separa: o medo tem objeto conhecido no mundo (medo do cachorro que está ali); a angústia é a espera de um perigo sem objeto definido; o susto é o encontro com o perigo sem qualquer preparação — e é o susto, não o medo, que produz neurose traumática. Quem estava com medo não fica traumatizado: o medo, paradoxalmente, protege.'},
      {nome:'As situações de perigo por idade',desc:'Freud organiza os perigos que angustiam segundo a fase: (1) perda do objeto — o bebê e a ausência da mãe; (2) perda do amor do objeto — a criança pequena; (3) angústia de castração — a fase fálica; (4) angústia diante do superego, a culpa — depois do Édipo. Perguntar de qual desses perigos a angústia atual é herdeira costuma abrir o caso: o adulto que teme o abandono está numa camada diferente do que teme a própria consciência.'},
      {nome:'Pânico — a angústia sem representação',desc:'Crise aguda com taquicardia, falta de ar, tremor, despersonalização e certeza de morte iminente. Do ponto de vista psicanalítico, é angústia automática pura: afeto sem representação ligada — o corpo grita o que não achou palavra. Clinicamente: descartar causa orgânica sempre; acolher a crise sem interpretar durante; e depois construir com o paciente o que estava acontecendo na vida dele nas semanas anteriores. O pânico costuma chegar quando algo estava prestes a mudar.'},
      {nome:'Inibição — o preço pago para não sentir',desc:'Restrição de uma função do Ego (trabalhar, escrever, comer, falar em público, transar) para evitar a angústia que aquela função convocaria. Não é sintoma — é renúncia preventiva. Clinicamente é discreta e por isso passa batida: o paciente não se queixa do que deixou de fazer. Vale sempre a pergunta sobre o que ele parou de fazer sem perceber, e desde quando.'}
    ]
  },
  {
    categoria:'Culpa, Vergonha e Necessidade de Punição',
    intro:'O território mais silencioso da clínica. Freud descobre que a culpa mais grave é justamente a inconsciente — aquela que o sujeito não sente como culpa, apenas vive como fracasso repetido. Base: O Ego e o Id (1923), O Mal-Estar (1930), O Problema Econômico do Masoquismo (1924).',
    itens:[
      {nome:'Culpa inconsciente',desc:'O sujeito não diz que se sente culpado — diz que está doente, azarado, incapaz, cansado. A culpa não chegou à consciência, mas comanda a vida. Freud a chamou de sentimento inconsciente de culpa e de necessidade de punição. Sinal clínico maior: o paciente piora justamente quando o tratamento começa a dar certo (reação terapêutica negativa). Melhorar seria perder a punição que o mantém em paz com o superego.'},
      {nome:'Necessidade de punição e masoquismo moral',desc:'A culpa busca castigo. Quando não há um algoz, o sujeito o produz: acidentes repetidos, escolhas ruinosas, relações que humilham, autossabotagem na véspera do sucesso. Não é falta de sorte nem falta de inteligência — é uma dívida sendo paga. Perguntar do que ele acha que está pagando costuma ser mais fértil do que perguntar o que ele quer.'},
      {nome:'Culpa e vergonha — não são a mesma coisa',desc:'A culpa diz respeito ao que se fez, é interna, envolve o superego e busca reparação — pede confissão e conserto. A vergonha diz respeito ao que se é, é relacional, envolve o ideal do Ego e o olhar do outro — e pede sumiço, esconderijo, invisibilidade. Confundir as duas erra o manejo: quem sente vergonha e é convidado a se explicar afunda mais. A vergonha precisa antes de acolhimento sem olhar julgador.'},
      {nome:'Superego severo e o paradoxo da virtude',desc:'Cada renúncia à agressividade não a apaga: entrega-a ao superego, que a devolve contra o próprio Ego. Por isso quanto mais o sujeito se contém, mais duro fica seu juiz interno. O paciente mais correto da sala costuma ser o mais castigado por dentro. Um superego cruel não é sinal de boa formação moral — é sintoma, e cede quando a agressividade encontra destino digno em vez de retorno.'},
      {nome:'Culpa do sobrevivente',desc:'Ficar vivo, saudável ou bem-sucedido onde alguém amado se perdeu ou fracassou gera dívida inconsciente. Aparece como impossibilidade de gozar o que se tem, adoecimentos nas datas da perda, lealdade invisível ao morto ou ao que ficou para trás. Clinicamente é frequente em quem perdeu pai, mãe, irmão ou filho — e em quem prosperou saindo de uma família que não prosperou.'},
      {nome:'Autoacusação que descreve outra pessoa',desc:'Manejo herdado de Luto e Melancolia e válido em toda culpa melancólica: escutar as autoacusações do paciente e perguntar a quem mais aquela descrição serviria. Com muita frequência a lista de defeitos que ele atribui a si é o retrato exato de alguém que ele amou e odiou. O ódio que não teve endereço voltou-se contra ele.'},
      {nome:'Culpa herdada e lealdade familiar',desc:'Nem toda culpa é do sujeito. Segredos, dívidas morais e vergonhas de gerações anteriores atravessam a família e são carregados por quem não os cometeu — Freud abre esse caminho em Totem e Tabu e no superego cultural do Mal-Estar. Investigar de quem é a culpa que o paciente carrega, e desde qual geração, muitas vezes é o que solta o nó.'}
    ]
  },
  {
    categoria:'Trauma e Abuso',
    intro:'Território que exige o máximo de cuidado e o mínimo de pressa. Toda escuta aqui é feita no tempo do paciente, jamais no tempo do terapeuta. Base: Estudos sobre a Histeria (vol. 2), Além do Princípio do Prazer (1920) e Inibição, Sintoma e Angústia (1926).',
    itens:[
      {nome:'Trauma — a definição econômica',desc:'Trauma não é medido pela gravidade do acontecimento, e sim pelo que o aparelho psíquico conseguiu processar. É a irrupção de uma quantidade de excitação que rompe a barreira protetora e não pode ser ligada em representação. Por isso um evento aparentemente pequeno pode ser traumático, e um evento grande pode não ser: o que decide é o desamparo naquele momento.'},
      {nome:'Os dois tempos do trauma',desc:'Freud descreve que o trauma se dá em dois tempos: um primeiro acontecimento que a criança viveu sem ter recursos simbólicos para entender, e um segundo momento, anos depois, em que algo o ressignifica e só então ele produz efeito devastador. Isso explica o paciente que adoece na idade adulta por algo que atravessou na infância aparentemente sem abalo — e explica por que a memória do trauma se constrói na análise, não se resgata pronta.'},
      {nome:'Abuso sexual na infância — efeitos duradouros',desc:'Marcas frequentes: confusão entre carinho e invasão, dificuldade de sentir o corpo como próprio, culpa e vergonha desproporcionais (a criança se acusa para preservar o adulto de quem depende), hipervigilância, dissociação durante o sexo, repetição de vínculos abusivos, sintomas ginecológicos e digestivos sem causa orgânica. A confusão de línguas de Ferenczi nomeia o núcleo: a criança fala a língua da ternura, o adulto responde na língua da paixão.'},
      {nome:'Silêncio, segredo e o pacto de não dizer',desc:'O que mais adoece muitas vezes não é o abuso em si, mas o descrédito e o silêncio que vieram depois — o adulto que não acreditou, a família que abafou, a exigência de conviver com o agressor. Isso instala no sujeito a desconfiança da própria percepção. Manejo central: acreditar e sustentar a palavra do paciente. Ser acreditado costuma ser a primeira reparação real.'},
      {nome:'Dissociação e amnésia',desc:'Diante do que não pode ser vivido, o psiquismo desliga: lacunas de memória de períodos inteiros, sensação de estar fora do corpo ou de assistir a si mesmo, tempo que some, funcionamento em compartimentos que não se comunicam. Não é mentira nem invenção — é defesa extrema e eficaz. Não forçar a lembrança: reconstruir o solo antes de mexer no que está enterrado.'},
      {nome:'Violência doméstica e o laço que prende',desc:'Por que não vai embora não é a pergunta certa. Operam ali dependência econômica e afetiva real, medo concreto, isolamento produzido pelo agressor, ciclo de agressão e reconciliação que renova a esperança, identificação com o agressor e a compulsão à repetição de um vínculo antigo. Manejo: sem julgar a permanência, cuidar da rede de apoio e da segurança concreta, e sustentar a escuta pelo tempo que ele levar. Havendo risco de vida, articular rede de proteção e serviços especializados.'},
      {nome:'Cuidado do terapeuta — trauma vicário',desc:'Escutar horror repetidamente marca quem escuta: pesadelos, embotamento, irritabilidade, perda de sentido no trabalho, excesso de identificação ou frieza defensiva. Não é fraqueza — é contratransferência somada a desgaste. Exige supervisão, análise pessoal, limite de quantos casos graves na agenda e intervalos reais entre sessões pesadas. Cuidar de quem cuida faz parte da técnica.'}
    ]
  },
  {
    categoria:'Sonhos — a via régia',
    intro:'A Interpretação dos Sonhos (1900) é a fundação de tudo. Todo sonho é a realização disfarçada de um desejo, e o disfarce é obra da censura. Ler um sonho na sessão é ler o inconsciente em movimento — e é a ferramenta mais barata e mais poderosa que a clínica tem.',
    itens:[
      {nome:'Conteúdo manifesto e conteúdo latente',desc:'O manifesto é o sonho como o paciente conta — a história com suas imagens absurdas. O latente é o desejo inconsciente que o originou. Entre um e outro está o trabalho do sonho, que traduz e disfarça. Interpretar não é decifrar símbolo por tabela pronta: é pedir as associações do próprio sonhador, porque só o dicionário dele serve.'},
      {nome:'Condensação',desc:'Uma única imagem do sonho carrega vários conteúdos ao mesmo tempo: uma pessoa com o rosto de uma, o nome de outra e a profissão de uma terceira. Por isso o sonho é curto e a associação é longa. Cada elemento do sonho costuma ter mais de uma raiz — não parar na primeira que aparece.'},
      {nome:'Deslocamento',desc:'A carga afetiva sai do elemento importante e se muda para um detalhe insignificante, driblando a censura. Por isso o que mais chama atenção no sonho geralmente não é o essencial, e um detalhe bobo que o paciente quase esqueceu de contar costuma ser a porta. Escutar o que ele descartou.'},
      {nome:'Figurabilidade e simbolismo',desc:'O sonho precisa transformar pensamento em imagem: abstrações viram cenas, relações lógicas viram vizinhança espacial, negação simplesmente some. Há símbolos de recorrência ampla (casa, viagem, água, escada, dentes, perder o trem), mas Freud adverte que o símbolo só vale quando confirmado pela associação do sonhador — a tabela pronta é o pior caminho.'},
      {nome:'Elaboração secundária',desc:'Ao acordar e contar, o sujeito costura as lacunas e dá lógica ao que era incoerente, tornando o sonho apresentável. É mais uma camada de censura. Por isso vale pedir o sonho o mais cru possível, com os furos e o disparate — e desconfiar da versão bem contada e redondinha.'},
      {nome:'Sonhos de angústia e pesadelos de repetição',desc:'Se todo sonho realiza um desejo, por que existe pesadelo? Porque o desejo realizado pode ser justamente o de punição, ou porque o disfarce falhou e a censura acordou o sonhador. Já os sonhos traumáticos que repetem literalmente o evento foram a exceção que levou Freud, em 1920, a formular a compulsão à repetição e ir além do princípio do prazer: ali o sonho não realiza desejo, tenta dominar retroativamente o susto.'},
      {nome:'O umbigo do sonho',desc:'Freud observa que todo sonho tem um ponto insondável, onde as associações se adensam e não vão adiante — o umbigo do sonho, ligado ao desconhecido. Reconhecer esse limite é técnica: não forçar interpretação onde não há material. O que não se deixou ler hoje volta em outro sonho.'},
      {nome:'Restos diurnos',desc:'Todo sonho se serve de material do dia anterior — uma cena banal, uma frase ouvida, um rosto na rua. Esses restos não são a causa do sonho: são a carona que o desejo inconsciente antigo pegou para chegar à noite. Perguntar o que aconteceu na véspera costuma abrir a ponte entre o sonho e a vida atual.'}
    ]
  },
  {
    categoria:'Atos Falhos e Psicopatologia da Vida Cotidiana',
    intro:'Freud (1901, vol. 6) demonstra que o inconsciente não se manifesta apenas na doença: ele aparece no cotidiano de todo mundo, em pequenos tropeços cheios de sentido. Na sessão, o ato falho é ouro — vem sem defesa e diz o que o paciente não ia dizer.',
    itens:[
      {nome:'Lapso de linguagem',desc:'A troca de palavra que revela a intenção recalcada: chamar o marido pelo nome de outro, dizer o contrário do que se pretendia, encerrar quando queria abrir. Não é distração nem cansaço — é uma segunda intenção conseguindo furar a fala. Na sessão, não deixar passar: devolver a palavra dita e perguntar o que ela lembra.'},
      {nome:'Esquecimento de nomes e de compromissos',desc:'Esquecer o nome de alguém, o remédio, a consulta, o aniversário. Freud mostra que o esquecimento é motivado: apaga-se o que se liga a algo desagradável, ou o que representa alguém contra quem há hostilidade recalcada. Faltar à sessão e esquecer o horário são material clínico de primeira ordem, não falha administrativa.'},
      {nome:'Ato falho de ação',desc:'Quebrar justamente o objeto presenteado por alguém, perder a aliança, deixar cair o que era caro, se ferir na véspera de um compromisso indesejado, errar o caminho conhecido. A mão faz o que a boca não disse. Perguntar o que estava por vir quando aquilo aconteceu costuma revelar a recusa que não pôde ser falada.'},
      {nome:'Extraviar e reencontrar objetos',desc:'Perder um objeto pode ser sacrifício simbólico — um pagamento inconsciente, uma forma de se livrar de quem o deu, ou de conjurar um mal maior. Reencontrá-lo quando a situação muda confirma a leitura. Vale investigar sobretudo os objetos que ele perde repetidamente.'},
      {nome:'Chistes e o riso',desc:'Em O Chiste e sua Relação com o Inconsciente (1905), Freud mostra que a piada permite dizer o proibido com licença social: a agressividade e o sexual passam pela porta do riso e ainda são aplaudidos. Reparar do que o paciente brinca — e principalmente das piadas que ele faz consigo mesmo, que costumam ser autoacusações sob anestesia.'},
      {nome:'Superstições e o acaso do sujeito',desc:'Freud observa que quem atribui sentido a todo acaso externo está projetando para fora a determinação que vem de dentro. Ele propõe o inverso: o acaso externo é acaso, mas o acaso dos próprios atos e escolhas nunca é. Isso reposiciona o paciente que se diz vítima do destino — e retoma a ideia do destino em grande parte arranjado pelo próprio sujeito.'}
    ]
  },
  {
    categoria:'Transferência, Resistência e Manejo Clínico',
    intro:'A técnica propriamente dita — o que se faz com o que se escuta. Base: os escritos técnicos de 1912-1915 (vols. 12 e 14) e o Compêndio (1938). Sem isto, a teoria vira erudição e a sessão vira conversa.',
    itens:[
      {nome:'Associação livre — a regra fundamental',desc:'Convite ao paciente para dizer tudo o que lhe vier, sem selecionar, sem julgar importância, mesmo que pareça bobo, ofensivo ou fora do assunto. Justamente o que ele quer pular é o que interessa. É a única regra do método, e é a partir da dificuldade de cumpri-la que a resistência aparece e pode ser trabalhada.'},
      {nome:'Atenção flutuante do analista',desc:'A contrapartida do lado de cá: escutar sem privilegiar nada de antemão, sem tomar notas mentais de tese, sem já ir montando o caso. Suspender a memória e o desejo de compreender depressa, para que o inconsciente do analista capte o do paciente. Compreender rápido demais costuma ser resistência do terapeuta.'},
      {nome:'Transferência positiva e negativa',desc:'O paciente repete no vínculo com o terapeuta os padrões afetivos antigos — não fala do passado, encena-o na sala. A transferência positiva (confiança, afeto, idealização) é o motor do tratamento e não se interpreta enquanto trabalha. A negativa (desconfiança, hostilidade, desvalorização) precisa ser nomeada, ou vira abandono do processo. Ambas são material, não obstáculo.'},
      {nome:'Contratransferência',desc:'O que o paciente desperta no terapeuta: tédio, irritação, sonolência, salvação, atração, pena, pressa de resolver. Freud a via como ponto cego a analisar; a clínica posterior mostrou que é também instrumento — o que sinto aqui pode ser exatamente o que ele provoca nas relações lá fora. Usar como bússola, nunca como atuação. Exige análise pessoal e supervisão.'},
      {nome:'Resistência — as formas que ela toma',desc:'Tudo que se opõe ao acesso ao inconsciente: silêncio, falar sem parar sobre o irrelevante, atrasos, faltas, esquecer de pagar, querer alta justo quando algo importante se aproximou, discutir teoria em vez de falar de si, sedução do terapeuta. A resistência não é má vontade: é a medida exata de quanto aquilo dói. Ela não é vencida — é interpretada.'},
      {nome:'Interpretação — quando e como',desc:'A interpretação só serve quando o paciente já está perto do material e a transferência a sustenta; dita cedo demais, ela é rejeitada ou aceita intelectualmente sem efeito nenhum. Melhor construir com ele do que revelar a ele. Uma boa interpretação abre associação nova — se fecha o assunto, provavelmente estava errada ou foi prematura.'},
      {nome:'Elaboração (Durcharbeitung)',desc:'Entender uma vez não muda nada. O trabalho real é a repetição paciente do mesmo material por caminhos diferentes, ao longo do tempo, até que o afeto acompanhe o insight. É a parte mais lenta e menos brilhante do tratamento — e é onde a mudança de fato acontece. Explica por que a análise leva o tempo que leva.'},
      {nome:'Recordar, repetir e elaborar',desc:'Freud (1914) resume o percurso: o que não pode ser recordado é repetido em ato; a tarefa da análise é transformar a repetição em recordação, e a recordação em elaboração. Quando o paciente encena em vez de lembrar, não se briga com a encenação — usa-se ela como texto.'},
      {nome:'Setting e abstinência',desc:'Horário fixo, duração constante, valor combinado, mesmo lugar, sigilo, ausência de relação fora dali. O enquadre não é burocracia: é o que torna significativo cada desvio dele. A regra de abstinência pede que o terapeuta não satisfaça as demandas transferenciais (conselho, adoção, amizade, salvação) — não por frieza, mas porque satisfazer a demanda cala o desejo que precisava aparecer.'},
      {nome:'Limites do método e encaminhamento',desc:'A psicanálise não substitui psiquiatria, medicação, rede de proteção nem urgência. Havendo risco de suicídio, surto psicótico, dependência química grave, violência em curso ou desnutrição, a escuta continua mas caminha junto com encaminhamento e rede. Saber a hora de pedir ajuda faz parte da técnica — e no atendimento integrativo, é o que separa o cuidado da imprudência.'}
    ]
  },
  {
    categoria:'O silêncio na sessão',
    intro:'Fonte direta no acervo: J.-D. Nasio (org.), "O silêncio na psicanálise" (Zahar, 2010) — o dossiê da jornada de Paris de 1985, mais Reik (1926), Morgenstern (1927), Fliess (1949) e os trechos de Freud e Lacan sobre o tema. É o único livro da estante dedicado inteiramente ao manejo do silêncio: o do paciente e o do terapeuta. Resumo completo em 03_Biblioteca/Psicanalise_Alem_de_Freud.',
    itens:[
      {nome:'Sileo e taceo — dois silêncios',desc:'O latim separa o que o português junta. Taceo é calar-se: a palavra não-dita, alguém que poderia falar e não fala — fato clínico, com causa e manejo. Sileo é o silêncio estrutural: a mudez de fundo do inconsciente e das pulsões, que não é de ninguém. Nasio observa que os primeiros discípulos de Freud só cuidaram do taceo (o problema técnico do paciente calado) e perderam o sileo. Sua tese: quando o terapeuta se cala na hora certa, não faz só uma manobra — mostra o silêncio da psique, e ao mostrar, convoca de volta o que mostra.'},
      {nome:'Nem todo silêncio é resistência',desc:'A correção mais importante do livro, e a que mais muda o atendimento. Reich (1928) lia o silêncio como defesa a combater e recomendava responder ao silêncio do paciente com outro silêncio, para forçá-lo à regra. Reik e Glover se opuseram: reduzir o silêncio a defesa é erro, porque o mutismo pode ser a resposta mais convincente a uma interpretação justa. Quando o paciente cala logo depois de você dizer algo certo, aquilo não é obstáculo — é a interpretação fazendo efeito. Insistir ali estraga o que acabou de acontecer.'},
      {nome:'Silêncio do começo, silêncio do fundo',desc:'Reik distingue as fases. Na primeira etapa do tratamento, pausas longas costumam ser resistência superficial: a pessoa se ajustando a uma situação estranha e insólita, sem equivalente na vida social — entregar a um estranho o que não se admite nem para si. Ler isso como material profundo é interpretar cedo demais. O silêncio denso vem depois, quando a zona recalcada começa a ser alcançada.'},
      {nome:'A Zona de Silêncio',desc:'A imagem de Reik para o recalcado. Perto da ilha de Vancouver existe um lugar onde nenhum ruído externo penetra por muitas milhas; nenhuma sirene avisa os capitães, e os navios que se despedaçaram ali repousam no fundo. O material recalcado é essa zona. Quando o paciente fala de si, os primeiros sons distantes, quase imperceptíveis, começam a alcançá-la. Serve para explicar ao paciente por que o processo é lento sem prometer revelação.'},
      {nome:'Quando as associações somam zero',desc:'Regra de ouro de Freud (1912), útil na semana que vem. Quando as associações realmente faltam — não as que o paciente cala por desprazer, mas as que não vêm mesmo — o obstáculo se levanta assegurando a ele que está sob o domínio de uma ideia ligada à pessoa do terapeuta. Dada a explicação, ou o obstáculo cai, ou a ausência de associações vira recusa de falar, que já é outra coisa e é trabalhável. Lacan confirma e amplia: quando o paciente se interrompe no meio do discurso, pode-se ter certeza de que um pensamento a seu respeito o ocupa.'},
      {nome:'O silêncio como não-saber do terapeuta',desc:'Liliane Zolty: o silêncio na sessão é a experiência cotidiana do não saber, a castração simbólica do analista, sua ignorância equivalente à do paciente. Pelo silêncio ele suspende a posição de saber, de compreensão e de julgamento. Mas o modo importa: o terapeuta não se abandona ao silêncio, deixa-se levar por ele até a precipitação de um dizer. Não é ficar mudo à toa; é deixar o silêncio conduzir até a fala que precisa vir.'},
      {nome:'"Não tenho nada a dizer" é verdade',desc:'Os pacientes dizem a verdade quando dizem que não têm nada a dizer — mas para encontrar esse nada é preciso falar. A arte é solicitar a palavra até que se esgotem as últimas miragens. O silêncio do terapeuta convoca esse nada, e não é demissão nem ausência: o que ele instaura não é vazio, é outra presença num silêncio compartilhado. Em análise, fala-se para criar o silêncio — assim como o grito funda o silêncio, só a palavra lhe dá existência.'},
      {nome:'Emmy von N. ensina Freud a se calar',desc:'A cena de origem, ainda no tempo da hipnose. Freud tem uma teoria sobre as dores gástricas de Emmy e a comunica; ela responde que não sabe nada disso e, no dia seguinte, em tom áspero, diz que ele não deve ficar perguntando de onde vem isso ou aquilo, mas deixá-la dizer o que ela tem a dizer. Freud consente e ela prossegue sem preâmbulo. Foi a paciente que recusou ser objeto de uma teoria e abriu o espaço da transferência. Lembrete permanente: a pressa de confirmar a própria hipótese fecha a porta que se queria abrir.'},
      {nome:'Aprovar pode frustrar mais que calar',desc:'Lacan, contra o terapeuta que fala para preencher: uma resposta à palavra vazia, mesmo e sobretudo aprovadora, mostra por seus efeitos ser bem mais frustrante do que o silêncio. O "hum-hum" simpático, o "que interessante" automático, o elogio reflexo — todos respondem à palavra vazia e a confirmam como vazia. Guardar silêncio, na expressão dele, não significa apenas não fazer barulho: significa calar-se em vez de responder.'},
      {nome:'O corpo do terapeuta responde sempre',desc:'Zolty: não há um silêncio do analista, há silêncios, no plural, em sua agitação murmurante, cada um em fase com o que está em ação no paciente. O que o terapeuta não sabe, o corpo dele comprova que não deixa de saber — ele se mexe, boceja, decide tomar notas, se recolhe. Consequência prática: se o paciente se inquietar porque você parece ter se afastado, é justo dizer-lhe que isso não o impede de escutar. E se a sua voz saiu trêmula, pomposa ou divagando, você provavelmente interveio fora do tempo lógico.'},
      {nome:'Desimpedir-se antes da sessão',desc:'Solange Nobécourt, no debate final, traz o termo de São João da Cruz: para ser procurador do silêncio com o corpo é preciso desimpedir-se — não apenas calar a boca, mas fazer calar em si a agitação imaginária e criar um espaço de vacuidade. Ela distingue a ressonância (résonance) do raciocínio (raisonnance, da ratio): o trabalho é criar um espaço onde a vibração silenciosa deixe surgir palavra viva, sem topar em algo tão fosco quanto o mutismo do túmulo. Neutralidade, etimologicamente, é ne-uter: não abolir — nem a si, nem ao paciente. É preparo, não técnica.'},
      {nome:'O silêncio como morte, e o trabalho mudo da pulsão',desc:'A camada sombria do tema, reunida de Freud. O processo do recalque se dá em silêncio (1911). No sonho e nos contos, o mutismo é representação usual da morte — Cordélia ama e se cala, ouro e prata são ruidosos, o chumbo é mudo (1913). Sobre a própria morte, tentamos lançar o véu do silêncio (1915). Silêncio, solidão e obscuridade são os elementos aos quais se liga a angústia infantil, que jamais desaparece inteiramente na maioria das pessoas (1919). E a pulsão de morte trabalha em silêncio, muda, só se manifestando quando se volta para fora como destruição (1924-1938). Um paciente que emudece pode estar perto de qualquer um desses lugares.'},
      {nome:'Silêncio como retenção — a leitura pulsional',desc:'A primeira linha histórica, ainda útil como hipótese. Ferenczi (1910) liga o calar-se à retenção anal: guardar ciumentamente o tesouro que as palavras, à maneira dos excrementos, representam no inconsciente — calar é reter com prazer. Abraham (1919) lê como defesa contra o erotismo oral. Robert Fliess (1949) sistematiza: a palavra é abertura erógena, o silêncio é fechamento dos orifícios, e há silêncios erótico-oral, erótico-anal e erótico-uretral. Daí uma leitura fina da dificuldade com a regra fundamental: temor deslocado de incontinência — falar assusta como deixar escapar.'},
      {nome:'Quando o silêncio é do lado de lá — mutismo e desenho',desc:'Sophie Morgenstern (1927), no primeiro texto francês sobre o tema, relata um caso de mutismo psicogênico infantil e, diante do impasse, inventa a técnica do desenho na análise de crianças — o desenho nasce como resposta do analista a um silêncio que não cede. Françoise Dolto, sua aluna, apresenta e comenta o caso. Lição de método: diante do mutismo, muda-se o canal da palavra, não a exigência de palavra. E vale a distinção clínica — mutismo eletivo, mutismo psicogênico e o silêncio do autismo não são a mesma coisa e não pedem o mesmo manejo.'}
    ]
  },
  {
    categoria:'Melanie Klein — o mundo interno e as posições',
    intro:'Klein (1882-1960) desce ao primeiro ano de vida e encontra ali um mundo já povoado de objetos, amor e ódio. Substitui as fases por posições — modos de funcionar que não se superam, se alternam a vida inteira. Da sua obra vem quase tudo que hoje se chama relações de objeto.',
    itens:[
      {nome:'Posição esquizoparanoide',desc:'Primeiro modo de funcionamento (grosso modo os 3-4 primeiros meses, mas ativo para sempre). O bebê ainda não integra: existe o seio bom que alimenta e o seio mau que falta, como se fossem dois objetos. A ansiedade central é persecutória — medo de ser destruído. Defesas: clivagem, idealização, negação onipotente, identificação projetiva. No adulto: pensamento em tudo-ou-nada, o outro é santo ou monstro, sensação de perseguição, incapacidade de ver defeito em quem se ama e virtude em quem se odeia.'},
      {nome:'Posição depressiva',desc:'Avanço decisivo: o bebê percebe que o seio bom e o mau são a mesma mãe — e que o ódio que dirigiu ao mau feriu quem ele ama. A ansiedade muda de natureza: não é mais medo de ser destruído, é dor por ter destruído. Nascem culpa, luto, gratidão e o desejo de reparar. É posição de conquista, não de doença: quem a alcança consegue amar alguém inteiro, com defeitos, sem precisar dividi-lo em dois.'},
      {nome:'Clivagem (splitting)',desc:'Separar o objeto e o próprio eu em partes boas e más para proteger o bom da contaminação do mau. É a defesa mais primitiva e a mais custosa: mantém a paz interna ao preço de nunca ver ninguém por inteiro — inclusive a si mesmo. Clinicamente aparece na idealização súbita do terapeuta seguida de desvalorização brusca, e em relações que só existem em extremos.'},
      {nome:'Identificação projetiva',desc:'Mais que projetar: o sujeito expulsa para dentro do outro uma parte de si (raiva, fraqueza, desespero) e passa a se relacionar com o outro como se ele fosse aquilo — e frequentemente o outro começa mesmo a sentir e agir assim. É comunicação primitiva e é o que explica a contratransferência intensa: o que o terapeuta sente na sessão pode ter sido depositado ali. Não é metáfora, é o que de fato acontece na sala.'},
      {nome:'Inveja e gratidão',desc:'Klein distingue inveja de ciúme: o ciúme quer o que o outro tem; a inveja quer estragar o que o outro tem, justamente porque é bom. A inveja ataca a própria fonte do bem — por isso sabota o tratamento que está ajudando, estraga o presente recebido, desqualifica quem cuida. Seu contrário é a gratidão, que permite receber e guardar dentro o que foi bom. Onde há inveja intensa, nada entra e nada fica.'},
      {nome:'Reparação',desc:'Movimento nascido da posição depressiva: consertar em fantasia e em ato o objeto que se sentiu ter danificado. É a raiz da criatividade, do trabalho, do cuidado e da própria vocação de curar. Mas há a reparação maníaca — consertar por onipotência, para não sentir culpa nem depender de ninguém, o que nunca alivia de fato. Vale perguntar, no terapeuta e no paciente, qual das duas está operando.'},
      {nome:'Fantasia inconsciente',desc:'Para Klein, a vida mental é feita de fantasia desde o início: toda pulsão vem acompanhada de um cenário com objetos. Não é imaginação voluntária — é a linguagem básica do mundo interno, que colore toda percepção da realidade. Por isso dois pacientes vivem o mesmo fato de modos incompatíveis: cada um o atravessa pela fantasia que o habita.'},
      {nome:'O brincar como associação livre da criança',desc:'A criança não associa livremente deitada num divã — ela brinca. Klein criou a técnica do brinquedo: caixa individual com material simples, e o jogo lido como se lê um sonho. Foi o que tornou possível analisar crianças pequenas, e é a origem de toda a clínica infantil psicanalítica.'},
      {nome:'Superego precoce e cruel',desc:'Contra Freud, Klein sustenta que o superego não espera o Édipo: existe desde muito cedo e é bem mais feroz que os pais reais — feito não do que os pais fizeram, mas da agressividade da própria criança projetada e devolvida. Explica a criança amada que se pune sem motivo, e o adulto cujo juiz interno é incomparavelmente pior que qualquer figura de sua história.'}
    ]
  },
  {
    categoria:'Lacan — o retorno a Freud',
    intro:'Lacan (1901-1981) relê Freud pela linguística e pela lógica: o inconsciente é estruturado como uma linguagem. Sua clínica desloca o eixo do eu para o sujeito e do sentido para o significante. Vocabulário difícil, efeito prático grande — sobretudo no manejo e no diagnóstico estrutural.',
    itens:[
      {nome:'Real, Simbólico e Imaginário',desc:'Os três registros que enodam a experiência. O Imaginário é o campo da imagem, do eu, da semelhança e da rivalidade com o outro. O Simbólico é a linguagem, a lei, o pacto, o que se pode dizer. O Real é o que resiste à simbolização — não é a realidade, é o que nela não se deixa dizer nem imaginar: o trauma, o gozo, a morte. Sofre-se de modo diferente em cada registro, e escutar em qual deles o paciente está muda a intervenção.'},
      {nome:'O estádio do espelho',desc:'Entre 6 e 18 meses a criança se reconhece no espelho e se alegra: vê uma unidade que seu corpo, ainda descoordenado, não tem. O eu nasce dessa identificação com uma imagem — ou seja, nasce de fora e é, na origem, uma alienação. Consequência clínica forte: o eu não é a sede da verdade do sujeito, é sua defesa mais bem acabada. Por isso reforçar o eu do paciente não é o objetivo da análise.'},
      {nome:'O inconsciente estruturado como uma linguagem',desc:'A condensação e o deslocamento de Freud são, para Lacan, metáfora e metonímia. O inconsciente não é um porão de instintos: é uma cadeia de significantes que se articula segundo leis próprias. Por isso a escuta vai à letra — ao chiste, ao equívoco, à palavra repetida, ao lapso — e não ao sentido que o paciente atribui ao que disse.'},
      {nome:'O desejo é o desejo do Outro',desc:'O sujeito deseja a partir do lugar que ocupou no desejo de quem cuidou dele: o que esperavam, temiam ou não puderam dizer sobre ele. Daí a pergunta que estrutura a neurose — o que sou eu para o Outro? A histeria responde fazendo-se objeto do desejo alheio e sustentando o desejo insatisfeito; a obsessão responde tornando o desejo impossível para não depender de ninguém.'},
      {nome:'Necessidade, demanda e desejo',desc:'A necessidade é do corpo e pode ser satisfeita (fome, frio). Ao ser dita, vira demanda — e toda demanda é sempre também demanda de amor. O desejo é o resto que sobra depois que a demanda foi atendida e ainda assim faltou algo. É por isso que dar ao paciente o que ele pede raramente resolve: atende-se a demanda e cala-se o desejo, que era o que precisava aparecer.'},
      {nome:'Nome-do-Pai e foraclusão',desc:'O Nome-do-Pai é o significante que instala a lei e a interdição, permitindo que a criança saia de ser o objeto que completa a mãe. Quando esse significante não se inscreve — foraclusão —, falta o ponto de amarração do simbólico e o que foi rejeitado retorna no real: alucinação e delírio. É a leitura lacaniana da psicose, e a base do manejo que não confronta o delírio.'},
      {nome:'Objeto a e gozo',desc:'O objeto a é o objeto para sempre perdido que causa o desejo — nunca se encontra, e é justamente por isso que se continua desejando. O gozo é diferente do prazer: é uma satisfação que vai além do princípio do prazer e chega a doer, presente no sintoma, na repetição, no vício, no sofrimento a que o sujeito se apega. Pergunta clínica incômoda e fértil: que satisfação este sofrimento lhe dá?'},
      {nome:'O sujeito suposto saber',desc:'A transferência se instala quando o paciente supõe que o analista sabe algo sobre ele que ele mesmo não sabe. É motor indispensável — e é uma suposição, não um fato. O analista que acredita saber de verdade sai do lugar e vira mestre. O fim da análise passa pela queda dessa suposição: o paciente descobre que o saber era dele.'},
      {nome:'Tempo lógico e sessão de tempo variável',desc:'A prática mais polêmica de Lacan, que lhe custou a exclusão da associação internacional. A sessão termina num ponto de corte escolhido pelo analista — não pelo relógio — para pontuar um significante e evitar que o paciente feche o sentido e se acalme. O tempo do inconsciente não é cronológico: há o instante de ver, o tempo de compreender e o momento de concluir.'},
      {nome:'A interpretação como corte, não como explicação',desc:'Consequência prática de tudo acima: interpretar não é revelar o significado oculto — é intervir na cadeia para abrir sentido novo. Escansão, pontuação, equívoco, repetir a palavra do paciente com outra entonação. Explicar demais fecha o inconsciente; o bom efeito de uma intervenção se mede por ela abrir associação, nunca por convencer.'}
    ]
  },
  {
    categoria:'Winnicott — o ambiente e o verdadeiro self',
    intro:'Winnicott (1896-1971), pediatra antes de analista, atendeu dezenas de milhares de crianças e mães. Traz para a psicanálise o que faltava: o ambiente real. Não existe bebê sozinho — existe bebê e cuidado. Sua clínica é morna, humana e especialmente útil no atendimento integrativo.',
    itens:[
      {nome:'Mãe suficientemente boa',desc:'Não a mãe perfeita — a que falha na medida certa. No começo ela se adapta quase totalmente às necessidades do bebê; depois falha aos poucos, no ritmo em que ele já pode suportar, e é justamente essa falha gradual que constrói a capacidade de esperar, de simbolizar e de existir separado. A mãe perfeita seria catastrófica: não deixaria o bebê descobrir que o mundo é outro. Alívio imenso para pais culpados, e para terapeutas onipotentes.'},
      {nome:'Holding e handling',desc:'Holding é o sustentar — físico e psíquico: o colo, a rotina previsível, a presença confiável que segura o bebê antes que ele tenha um eu para se segurar. Handling é o modo de manusear o corpo, de onde nasce o habitar o próprio corpo (personalização). Na clínica, o setting é holding: horário, constância e confiabilidade seguram o paciente antes de qualquer interpretação — e para muitos pacientes isso é o tratamento inteiro.'},
      {nome:'Objeto transicional',desc:'O paninho, o ursinho, a fralda que a criança não larga. Não é ela nem é o mundo: é o primeiro não-eu possuído, criado e encontrado ao mesmo tempo. Ocupa a zona intermediária entre a fantasia e a realidade, e ninguém pode perguntar à criança se ela o criou ou o achou — a pergunta não deve ser feita. Dele descendem a arte, a religião e toda a vida cultural.'},
      {nome:'Espaço potencial e o brincar',desc:'A zona entre o sujeito e o mundo onde a experiência é criativa: nem alucinação pura, nem submissão à realidade dura. É ali que se brinca, e para Winnicott brincar é o próprio trabalho da saúde. Frase que reorganiza a técnica: a psicoterapia acontece na sobreposição de duas áreas de brincar, a do paciente e a do terapeuta — e se o paciente não consegue brincar, a tarefa primeira é torná-lo capaz disso.'},
      {nome:'Verdadeiro self e falso self',desc:'O verdadeiro self é o gesto espontâneo, o que nasce de dentro e faz a vida parecer real. O falso self se forma quando o ambiente exige submissão precoce: a criança aprende a adivinhar e atender o que esperam dela, e constrói uma fachada competente que protege o núcleo escondido. Sinal clínico maior: o paciente que tem tudo, funciona bem, não se queixa de nada — e diz que a vida é vazia e não sente que está vivendo.'},
      {nome:'Capacidade de estar só',desc:'Paradoxo winnicottiano: só aprende a ficar sozinho quem pôde estar só na presença de alguém — a criança absorta no brinquedo enquanto a mãe está por perto, sem intervir. A solidão saudável é herdeira dessa presença silenciosa. Quem não a teve não fica só: fica abandonado, e por isso não suporta o silêncio, nem na vida nem na sessão.'},
      {nome:'Preocupação materna primária',desc:'Estado de sensibilidade extrema que toma a mãe no fim da gravidez e nas primeiras semanas — uma identificação quase completa com o bebê, que Winnicott compara a um retraimento e diz que seria doença se não houvesse bebê. Não é patologia, é função. Ponte direta com o quarto trimestre e a exterogestação: sustentar a mãe é sustentar o bebê.'},
      {nome:'Agressividade e sobrevivência do objeto',desc:'A criança precisa poder atacar o objeto amado e descobrir que ele sobrevive — não retalia nem desaba. Só o objeto que sobrevive à destruição passa a existir de fato como outro, fora do controle onipotente. Na clínica: quando o paciente ataca o terapeuta, a intervenção decisiva é sobreviver sem retaliar e sem se despedaçar. É assim que ele descobre que existe alguém ali de verdade.'},
      {nome:'Tendência antissocial como esperança',desc:'O furto, a mentira, a destrutividade na criança e no adolescente sinalizam que houve uma privação real depois de ter havido algo bom — e que o sujeito ainda espera que o ambiente devolva o que tirou. É pedido, não maldade. Winnicott a chama de sinal de esperança: a criança que já desistiu não rouba mais.'}
    ]
  },
  {
    categoria:'Bion — pensar o que não se pode pensar',
    intro:'Bion (1897-1979), veterano de guerra e analisando de Klein, estuda como o pensamento se forma — e o que acontece quando não se forma. Traz o modelo mais útil para entender o que o terapeuta faz quando apenas escuta e suporta.',
    itens:[
      {nome:'Elementos beta e função alfa',desc:'Elementos beta são impressões brutas, sensações e emoções cruas que não podem ser pensadas, apenas evacuadas — em ato, no corpo ou dentro do outro. A função alfa é a capacidade de transformá-los em elementos alfa, que já podem ser sonhados, lembrados e pensados. Onde a função alfa falhou, o sofrimento não vira palavra: vira sintoma somático, agitação ou descarga.'},
      {nome:'Rêverie',desc:'O estado de devaneio receptivo da mãe que acolhe a angústia bruta do bebê, a metaboliza dentro de si e a devolve tolerável. É assim que o bebê toma emprestada uma função alfa que ainda não tem — e aos poucos a constrói. Na sessão, é exatamente o que o terapeuta faz ao receber o insuportável do paciente sem devolvê-lo cru.'},
      {nome:'Continente e contido',desc:'Toda experiência emocional precisa de um continente que a suporte. Continente frágil: transborda, e o sujeito adoece ou explode. Continente rígido: esmaga a experiência e mata a vida psíquica. O bom continente é elástico — deforma-se e não se rompe. O enquadre, o terapeuta e o próprio corpo funcionam como continentes, e é útil perguntar qual deles está falhando.'},
      {nome:'Ataques ao vínculo',desc:'Quando pensar dói demais, o aparelho não ataca o conteúdo: ataca a própria ligação entre as coisas. O resultado é fala fragmentada, raciocínio que não fecha, relações que se rompem sem motivo aparente, incapacidade de juntar causa e efeito na própria história. Não é falta de inteligência — é uma defesa contra a dor de estabelecer a ligação.'},
      {nome:'Sem memória e sem desejo',desc:'A recomendação técnica mais radical de Bion: entrar em cada sessão sem a memória do caso e sem o desejo de que algo aconteça — nem melhora, nem insight, nem gratidão. Memória e desejo enchem o espaço e impedem de escutar o que está acontecendo agora. É a atenção flutuante de Freud levada ao extremo, e vale como higiene para todo terapeuta que já sabe demais sobre o paciente.'},
      {nome:'Frustração: tolerar ou evadir',desc:'Diante da falta (o seio que não vem), abrem-se dois caminhos. Tolerar a frustração obriga a pensar — o pensamento nasce como substituto da coisa ausente. Não tolerá-la leva a evacuar: agir, adoecer, usar substância, alucinar a satisfação. Toda a diferença entre um psiquismo que pensa e um que descarrega passa por aqui, e explica por que a capacidade de esperar é tão terapêutica.'},
      {nome:'Grupos de suposição básica',desc:'Bion mostrou que grupos regridem a modos primitivos que atrapalham a tarefa real: dependência (esperam um líder que salve), luta-e-fuga (precisam de um inimigo), acasalamento (esperam que uma dupla ou uma novidade futura resolva tudo). Útil para ler famílias, equipes e as dinâmicas do próprio consultório.'}
    ]
  },
  {
    categoria:'Ferenczi — a ternura e o reconhecimento do trauma',
    intro:'Ferenczi (1873-1933), o mais clínico dos discípulos de Freud, insistiu no trauma real quando a psicanálise se voltava para a fantasia. Foi marginalizado por isso e reabilitado décadas depois. É a fonte indispensável para atender abuso.',
    itens:[
      {nome:'Confusão de línguas entre os adultos e a criança',desc:'Seu texto maior (1932). A criança fala a língua da ternura — quer colo, carinho, brincadeira. O adulto responde na língua da paixão, erotizada e culpada. A criança não tem como recusar nem como entender, e o que ocorre não é sedução: é invasão. O núcleo do dano está nessa confusão, e não apenas no ato.'},
      {nome:'Identificação com o agressor',desc:'Diante do terror, a criança não luta nem foge: ela se anula e se transforma no que o agressor espera, adivinhando seus desejos para sobreviver. Introjeta também a culpa dele — e sai da cena sentindo-se ela a culpada. Explica a lealdade ao abusador, a autoacusação da vítima e a docilidade extrema de quem foi ferido cedo.'},
      {nome:'O terrorismo do sofrimento',desc:'A criança em ambiente adoecido assume a responsabilidade pelo sofrimento dos adultos e se torna cuidadora precoce dos próprios pais. Cresce hipersensível ao estado emocional alheio, incapaz de ter necessidades próprias e convencida de que a dor dos outros é obra sua. Muito frequente entre terapeutas, aliás.'},
      {nome:'A criança mal acolhida',desc:'O sujeito que percebeu, antes de ter palavras, que sua chegada não era desejada. Carrega um pessimismo de fundo, ausência de vontade de viver que não se explica pela biografia, tendência a adoecer e a se retirar. Ferenczi observa que essas pessoas morrem com facilidade e sem luta — e que reconhecer isso na análise já muda o rumo.'},
      {nome:'Elasticidade da técnica',desc:'Contra a neutralidade fria, Ferenczi propõe que a técnica se estique conforme o paciente: o mais grave precisa de mais presença, mais tato, mais calor. Regra que ele deixou: a técnica é elástica, mas elástico tem limite e deve voltar à forma — flexibilizar não é abolir o enquadre nem virar amigo.'},
      {nome:'O reconhecimento como reparação',desc:'A descoberta clínica mais valiosa: o que retraumatiza não é lembrar, é ser desmentido de novo. O analista que hesita, minimiza ou interpreta como fantasia repete o gesto do adulto que não acreditou. Reconhecer que aquilo aconteceu e foi grave é, muitas vezes, a primeira reparação real que o paciente recebe na vida.'},
      {nome:'A análise mútua e seu fracasso — lição de limite',desc:'Ferenczi chegou a experimentar ser analisado por seus próprios pacientes, buscando horizontalidade. O experimento fracassou e ele mesmo o abandonou, mas deixou uma herança honesta: a contratransferência precisa ser reconhecida e trabalhada, e não confessada ao paciente. Vale como advertência a quem confunde acolhimento com se despejar sobre quem veio buscar ajuda.'}
    ]
  },
  {
    categoria:'Anna Freud e a Psicologia do Ego',
    intro:'Anna Freud (1895-1982) sistematiza as defesas, funda a análise de crianças na linha vienense e abre a corrente que vê o ego não só como vítima de conflitos, mas como instância com forças próprias. Foi a adversária teórica de Klein no grande debate que dividiu a psicanálise inglesa.',
    itens:[
      {nome:'O ego e os mecanismos de defesa (1936)',desc:'O livro que organizou o campo: a análise deve começar pelas defesas, não pelo conteúdo recalcado. Antes de chegar ao que o paciente esconde, é preciso reconhecer como ele esconde — porque o modo de defender-se é mais constante e mais revelador que o segredo defendido.'},
      {nome:'Identificação com o agressor — a versão dela',desc:'Anna Freud descreve o mecanismo pelo qual o sujeito ameaçado assume os atributos de quem o ameaça, transformando-se de vítima em quem exerce a mesma força. Diferente da leitura de Ferenczi, que enfatiza a submissão e a introjeção da culpa. As duas se somam bem na clínica: uma explica quem se anula, a outra explica quem repete no lugar do agressor.'},
      {nome:'Altruísmo defensivo',desc:'Renunciar aos próprios desejos e vivê-los pela satisfação de outra pessoa — o pai que só vive pelos filhos, o cônjuge que só quer o bem do outro, o terapeuta que se anula. Parece virtude e alivia a culpa, mas cobra caro: o desejo próprio nunca é reconhecido, e costuma retornar como amargura, adoecimento ou cobrança.'},
      {nome:'Linhas de desenvolvimento',desc:'Em vez de fases rígidas, Anna Freud propõe linhas que avançam em ritmos diferentes: da dependência à autonomia, do corpo cuidado ao autocuidado, do brinquedo ao trabalho. Uma criança pode estar adiantada numa linha e atrasada em outra, e isso é normal. Ferramenta boa para avaliar desenvolvimento sem reduzir tudo a uma escada única.'},
      {nome:'Análise de crianças e o papel dos pais',desc:'Diferente de Klein, Anna Freud sustentava que a criança não faz transferência plena — os pais ainda estão vivos e presentes — e que uma fase preparatória e o trabalho com os pais são indispensáveis. Divergência histórica que rendeu as Discussões Controversas, e que na prática segue viva: quanto envolver a família no tratamento de uma criança.'},
      {nome:'Aliança terapêutica e ego observador',desc:'Herança forte da psicologia do ego: parte do paciente precisa se aliar ao tratamento e conseguir olhar para si mesma enquanto sente — o ego observador. Sem essa parte, interpretar é despejar no vazio. Avaliar se existe ego observador é um dos primeiros julgamentos clínicos a fazer.'}
    ]
  },
  {
    categoria:'Françoise Dolto — a criança e a imagem do corpo',
    intro:'Dolto (1908-1988) leva a psicanálise ao rádio e às creches da França, e sustenta uma tese radical: o bebê é um sujeito desde o início, entende a verdade que lhe dizem e adoece do que lhe é calado. Ponte natural com o trabalho corporal.',
    itens:[
      {nome:'Imagem inconsciente do corpo',desc:'Distinta do esquema corporal, que é neurológico e comum a todos. A imagem inconsciente do corpo é singular: é a memória viva das relações, feita da história de cada zona do corpo com o cuidado, o toque, a palavra e a falta. Duas pessoas com a mesma anatomia habitam corpos completamente diferentes — e é essa imagem que adoece, não o esquema.'},
      {nome:'Falar a verdade à criança',desc:'Princípio central de Dolto: a criança sabe, ainda que não saiba que sabe. O que a adoece não é a notícia difícil (a morte, a separação, a doença, a adoção), é o silêncio e a mentira em volta dela. Dizer a verdade em palavras simples, na hora certa, alivia sintomas que nenhuma outra medida resolve.'},
      {nome:'Castrações simbolígenas',desc:'Dolto renomeia as passagens do desenvolvimento como castrações que geram símbolo: o desmame, o controle dos esfíncteres, a interdição do incesto. Cada renúncia, quando acompanhada de palavra que a explique, não empobrece — abre uma capacidade nova. Sem a palavra, a mesma renúncia vira ferida.'},
      {nome:'O sintoma da criança fala da família',desc:'A criança costuma ser o porta-voz do que a família não diz: o segredo, o luto não feito, o conflito do casal. Ela adoece no lugar do sistema. Consequência prática: atender a criança sem escutar a família é tratar o sintoma no mensageiro.'},
      {nome:'A palavra que cura e o valor do dizer ao bebê',desc:'Dolto falava com recém-nascidos sobre sua história — a gravidez, o parto difícil, a ausência do pai, a hospitalização — e observava sintomas cederem. A explicação psicanalítica: o bebê capta o afeto e a intenção da palavra dirigida a ele como sujeito, e o que foi nomeado deixa de ser um enigma angustiante sem forma.'},
      {nome:'A síndrome do vestíbulo — permanecer no limiar',desc:'Descrição doltoana do sujeito que fica na soleira e não atravessa: o adolescente que não sai, o adulto que não começa a vida, quem permanece à porta da própria existência. Ligada a passagens simbólicas que não foram feitas, ou que ninguém acompanhou com palavra.'}
    ]
  },
  {
    categoria:'Jung — a dissidência e o simbólico',
    intro:'Jung (1875-1961) rompe com Freud em 1913 e funda a psicologia analítica. Não é psicanálise em sentido estrito, e essa distinção precisa estar dita — mas é a corrente que mais dialoga com o simbólico, a alquimia, a astrologia e a Cabala, e por isso conversa diretamente com os outros módulos da plataforma.',
    itens:[
      {nome:'Inconsciente coletivo',desc:'Além do inconsciente pessoal, feito da biografia de cada um, Jung postula uma camada mais funda e comum à espécie, feita de estruturas herdadas de imagem e sentido. É a tese que motivou a ruptura com Freud, e é a mais discutida: não é demonstrável nos termos da ciência experimental, e deve ser tratada como hipótese fecunda, não como fato.'},
      {nome:'Arquétipos',desc:'Formas vazias e universais que organizam a experiência e se preenchem com o material de cada cultura e cada vida: a Mãe, o Pai, a Criança, o Velho Sábio, o Herói, o Trapaceiro. Não são imagens fixas, são moldes. É o conceito que abre a leitura de mitos, contos, Tarô e símbolos religiosos como material clínico legítimo.'},
      {nome:'Sombra',desc:'Tudo que o sujeito não admite em si e por isso projeta no outro: a agressividade, a ambição, a inveja, a sexualidade recusada, mas também talentos que dariam trabalho assumir. Quanto mais impecável a autoimagem, mais densa a sombra. Trabalho central: reconhecer como próprio o que se odeia nos outros — o que irrita demais no outro costuma ter endereço em casa.'},
      {nome:'Persona',desc:'A máscara social, o papel que se apresenta ao mundo — necessária para viver em sociedade e perigosa quando o sujeito se identifica inteiramente com ela e não sabe mais quem é sem o cargo, o título ou a função. Parente próxima do falso self de Winnicott, por caminho independente.'},
      {nome:'Anima e Animus',desc:'A imagem interna do gênero complementar, formada nas primeiras relações e projetada nas escolhas amorosas — o que explica a paixão fulminante por alguém que mal se conhece: ama-se a projeção. Formulado num vocabulário de época bastante datado; o valor clínico permanece se lido como a parte não vivida de si que se busca no outro.'},
      {nome:'Individuação',desc:'O processo de tornar-se quem se é: integrar sombra, persona e as partes dissociadas até se aproximar do Self, o centro que inclui consciente e inconsciente. Não é ficar perfeito nem feliz — é ficar inteiro. Costuma se intensificar na segunda metade da vida, quando as conquistas externas param de bastar.'},
      {nome:'Sincronicidade',desc:'Coincidência significativa entre um estado interno e um evento externo, sem relação causal entre eles. Jung a formula em diálogo com o físico Wolfgang Pauli. É a ideia mais contestada de sua obra e não tem estatuto científico — mas é a que sustenta o uso do Tarô, do I Ching e da astrologia como espelhos do momento psíquico, e vale usá-la assumindo isso com todas as letras.'},
      {nome:'Alquimia como mapa do processo psíquico',desc:'Jung leu os tratados alquímicos como descrição simbólica da transformação interior, não como química: nigredo (o escurecimento, a crise e a depressão), albedo (a purificação e o discernimento), rubedo (a integração e o retorno à vida). Ponte direta com a Metafísica, a Árvore da Vida e a Astrologia dentro do OS.'},
      {nome:'Onde Jung e Freud se separam — e por que importa dizer',desc:'Freud lê o símbolo para trás, até o desejo infantil recalcado; Jung o lê para a frente, como indicação do que o psiquismo busca realizar. Freud entende a libido como energia sexual; Jung, como energia psíquica geral. Nenhuma das duas leituras anula a outra na prática, mas misturá-las sem avisar produz confusão. Ao usar Jung com um paciente, vale dizer que se está mudando de escola.'}
    ]
  },
  {
    categoria:'Kohut e a Psicologia do Self',
    intro:'Kohut (1913-1981) reformula o narcisismo: em vez de defeito moral a ser confrontado, uma necessidade de desenvolvimento que não foi atendida. Muda o tom da clínica com pacientes narcísicos, que a técnica clássica costumava perder.',
    itens:[
      {nome:'Objeto-self (selfobject)',desc:'O outro vivido não como pessoa separada, mas como parte do próprio self, cumprindo uma função psíquica que o sujeito ainda não faz sozinho. Todos precisamos de objetos-self a vida inteira, em graus variados — o que muda é a intensidade e a rigidez da dependência.'},
      {nome:'As três necessidades: espelhamento, idealização, gemelaridade',desc:'Espelhamento: ser visto e admirado por alguém que se ilumina com a nossa existência. Idealização: poder admirar alguém forte e calmo e tomar emprestada sua força. Gemelaridade: encontrar alguém semelhante e sentir-se parte da humanidade. Quando faltaram na infância, ficam buscadas com voracidade na vida adulta — e reaparecem na transferência.'},
      {nome:'Ferida narcísica e raiva narcísica',desc:'A raiva narcísica não é agressividade comum: é resposta a uma afronta ao self, tem qualidade implacável, não cede com o tempo e busca a eliminação do ofensor. Não se acalma com argumento nem com confronto. Só cede quando a ferida é reconhecida — o que muda por completo o manejo do paciente que explodiu com o terapeuta.'},
      {nome:'Empatia como método, não como gentileza',desc:'Para Kohut, a empatia é o instrumento de observação da psicanálise: conhecer pela imersão na experiência interna do outro. Não é ser simpático nem concordar — é o modo de coletar o dado clínico. Interpretações feitas de fora, por mais corretas, são vividas por esses pacientes como novas afrontas.'},
      {nome:'Frustração ótima e internalização transmutadora',desc:'Como o self cresce: por falhas empáticas pequenas, inevitáveis e reparadas — o terapeuta erra na medida do suportável, reconhece e retoma. A cada ciclo, o paciente internaliza um pedaço da função que o outro cumpria e passa a fazê-la sozinho. É o equivalente kohutiano da falha suficientemente boa de Winnicott.'},
      {nome:'Self grandioso e self esvaziado',desc:'Duas faces do mesmo quadro: a grandiosidade exibida (superioridade, exigência de admiração, desprezo) e o vazio que ela cobre (tédio crônico, sensação de irrealidade, depressão sem motivo, hipocondria). Tratar apenas a face visível confirma a defesa. O sofrimento verdadeiro está do outro lado.'}
    ]
  },
  {
    categoria:'Roudinesco — história e crítica da psicanálise',
    intro:'Élisabeth Roudinesco (1944-) é historiadora e psicanalista, biógrafa de Lacan e de Freud. Sua contribuição não é uma técnica: é a consciência histórica e crítica do próprio campo — saber de onde vem o que se pratica, e o que se disputa hoje em torno disso. Desde 29/07/2026 o "Dicionário de psicanálise" que ela escreveu com Michel Plon está no acervo (ver a categoria seguinte).',
    itens:[
      {nome:'A psicanálise tem história, não só doutrina',desc:'Roudinesco mostra que os conceitos nasceram em contextos concretos — guerras, exílios, rupturas institucionais, disputas pessoais. Saber que a técnica do tempo variável custou a Lacan a exclusão da associação internacional, ou que Ferenczi foi marginalizado por insistir no trauma real, muda o modo de ler a teoria: não como revelação, mas como campo em disputa.'},
      {nome:'Por que a psicanálise?',desc:'Sua defesa central diante da era do desempenho: a sociedade contemporânea oferece protocolos rápidos, avaliação e medicação para transformar o sujeito sofredor em indivíduo eficiente. A psicanálise resiste ao propor o contrário — tempo, palavra, e a suposição de que o sintoma tem sentido e pertence a uma história singular.'},
      {nome:'A crítica ao DSM e à medicalização',desc:'O deslocamento do sofrimento psíquico para listas de sintomas e categorias sem sujeito produz diagnóstico rápido e prescrição rápida — e faz desaparecer a pergunta sobre o que aquilo quer dizer na vida daquela pessoa. Crítica que não nega a psiquiatria nem a medicação: nega que a lista substitua a escuta.'},
      {nome:'A família em desordem',desc:'Roudinesco acompanha a transformação da família — divórcio, recomposição, homoparentalidade, reprodução assistida — e sustenta que a função paterna é simbólica e não depende da configuração biológica ou de gênero. Argumento útil no consultório contra leituras normativas que atribuem todo sofrimento à forma da família.'},
      {nome:'O paciente de hoje não é o de Freud',desc:'Menos histerias de conversão espetaculares, mais depressão, pânico, dependências, transtornos alimentares, queixas de vazio e de identidade. A escuta permanece; os quadros mudaram com a época. Ler o sofrimento contemporâneo com categorias de 1900 sem atualização é anacronismo — e ela documenta essa passagem.'},
      {nome:'Sobre Freud, sem hagiografia e sem demolição',desc:'Sua biografia de Freud recusa as duas tentações: o santo intocável e o impostor a ser desmascarado. Mostra os erros, as contradições, os casos que fracassaram, e ainda assim sustenta a potência da descoberta. É o exemplo de postura que o módulo inteiro procura ter: admirar sem venerar, criticar sem destruir.'}
    ]
  },
  {
    categoria:'Dicionário de psicanálise (Roudinesco & Plon)',
    intro:'Fonte direta no acervo desde 29/07/2026: E. Roudinesco e M. Plon, "Dicionário de psicanálise" (Zahar, 1998), supervisão brasileira de Marco Antonio Coutinho Jorge. Cerca de mil verbetes, cada um com o termo em alemão, espanhol, francês e inglês, quem criou, quando, e a controvérsia que carrega. Não é livro de leitura corrida: é o que se abre quando um termo aparece na supervisão ou num texto e a definição precisa estar certa. Estes são os verbetes que mais mudam a conduta na sala.',
    itens:[
      {nome:'A posteriori (Nachträglichkeit)',desc:'Introduzido por Freud em 1896; no Brasil também chamado "só-depois". Um acontecimento traumático não tem sentido pronto no momento em que ocorre: ele adquire significação num contexto histórico e subjetivo posterior, que o reinscreve. O sujeito constitui seu passado reconstruindo-o em função de um futuro ou de um projeto. Lacan, em 1953, deu ao termo sua maior extensão, no contexto do significante e do "tempo para compreender". Consequência clínica: não se corre atrás da cena original como se fosse um fato a recuperar intacto — o que se escuta é a reinscrição, e ela pode mudar. Também explica por que algo antigo dói agora e não doía antes.'},
      {nome:'Análise selvagem',desc:'Nome dado por Freud em 1910 a um erro técnico preciso: atirar no rosto do paciente, logo no primeiro encontro, os segredos que se julgou adivinhar. O caso que originou o termo foi o de um médico novato que explicou "selvagemente" a uma paciente que ela sofria de falta de atividade sexual. O ponto decisivo: seja a interpretação verdadeira ou falsa, ela é inaceitável, porque provém do desconhecimento completo da estrutura psíquica daquela pessoa, de suas resistências e de seu recalque. Freud condenou ainda os "diagnósticos relâmpago", chamando-os de abuso de poder, e recusou interpretar sonhos de alguém ausente. Advertência permanente contra a mania interpretativa — e Roudinesco observa que o gozo interpretativo aumentou, em vez de diminuir, com as advertências.'},
      {nome:'Atenção flutuante (Gleichschwebende Aufmerksamkeit)',desc:'Termo criado por Freud em 1912 para a regra técnica do lado de cá: escutar o paciente sem privilegiar nenhum elemento do discurso, deixando a própria atividade inconsciente entrar em ação. É a contrapartida exata da regra fundamental — se ao paciente se pede que não selecione o que diz, ao terapeuta se pede que não selecione o que ouve. O nome alemão diz o que a tradução perde: uma atenção que paira em suspensão equilibrada, sem pousar.'},
      {nome:'Por que consultar um dicionário e não só a memória',desc:'Termos como identificação, angústia, gozo, pulsão, self e sujeito têm sentidos diferentes conforme o autor e a década, e muita confusão de supervisão vem de dois interlocutores usando a mesma palavra com sentidos distintos. O dicionário resolve isso mostrando quem cunhou, quando, contra o quê, e o que a tradução perdeu — o problema clássico sendo o "Ich/Es/Über-Ich" de Freud virando "ego/id/superego" latinizados na tradução inglesa, com perda do pronome cotidiano que ele escolheu de propósito. Regra de uso: antes de aplicar um conceito com peso na sessão, conferir se ele quer dizer o que se acha que quer dizer.'}
    ]
  },
  {
    categoria:'As escolas em diálogo — como escolher a lente',
    intro:'Categoria de orientação, não de doutrina. Diante de um mesmo paciente, cada escola ilumina uma coisa. Escolher a lente é decisão clínica, e misturar sem saber que se está misturando é o erro mais comum de quem estuda muitas correntes.',
    itens:[
      {nome:'O mesmo sintoma visto por cada lente',desc:'Uma paciente que idealiza e depois destrói o terapeuta: Freud vê ambivalência e transferência; Klein vê clivagem e inveja atacando o objeto bom; Winnicott vê se o ambiente sobrevive à destruição; Lacan escuta a que demanda ela responde; Kohut vê a ferida narcísica reagindo a uma falha empática. Nenhuma leitura é a verdadeira — cada uma sugere uma intervenção diferente, e a escolha se justifica pelo efeito.'},
      {nome:'Quando o eixo é o ambiente real',desc:'Havendo privação, negligência, abuso ou trauma documentado, as lentes mais férteis são Ferenczi, Winnicott e Bion: reconhecimento, holding, continente, sobrevivência do objeto. Interpretar desejo inconsciente antes de reconhecer o que de fato aconteceu tende a repetir o desmentido e perder o paciente.'},
      {nome:'Quando o eixo é o mundo interno',desc:'Havendo relações que só existem em extremos, inveja que sabota o que ajuda, sensação de perseguição, culpa esmagadora após a raiva: a lente kleiniana costuma organizar melhor o caso — posições, clivagem, identificação projetiva e reparação.'},
      {nome:'Quando o eixo é a palavra e o desejo',desc:'Havendo dúvida obsessiva, insatisfação estrutural, sintoma que se repete apesar de compreendido, sujeito que sabe tudo sobre si e não muda: a lente lacaniana ajuda — escutar o significante, cortar o sentido pronto, não responder à demanda, perguntar que satisfação o sofrimento entrega.'},
      {nome:'Quando o eixo é o self ferido',desc:'Havendo exigência de admiração, explosões desproporcionais a críticas pequenas, vazio crônico sob a fachada de sucesso: a lente de Kohut evita o erro clássico de confrontar a grandiosidade. Reconhecer a ferida vem antes de qualquer interpretação, sob pena de o paciente abandonar o tratamento.'},
      {nome:'Quando o eixo é simbólico e espiritual',desc:'Havendo sonhos numinosos, crise de sentido na segunda metade da vida, busca religiosa ou trabalho com símbolos, Tarô, astrologia e Cabala: Jung é a lente que dá lugar a isso sem reduzir. Dizer ao paciente que se está usando outra escola, e não confundir a leitura simbólica com diagnóstico psicanalítico.'},
      {nome:'A regra contra o ecletismo cego',desc:'Usar muitas escolas é legítimo; usar sem saber qual está em uso não é. Antes de intervir, vale a pergunta interna: de qual autor é a ideia que estou aplicando agora, e ela combina com o que fiz na sessão passada? Trocar de lente no meio de um caso sem perceber produz intervenções contraditórias, e o paciente sente a incoerência antes do terapeuta.'}
    ]
  }
];
