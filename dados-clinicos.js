...
// ATENÇÃO À PROCEDÊNCIA: 03_Biblioteca/Freud só tem Freud. Estas 11 categorias
// NÃO saíram de PDF do acervo do Montgomery — foram escritas do conhecimento
// da literatura psicanalítica. São seguras como mapa e como orientação de
// leitura, mas não substituem a obra: quando ele adquirir os originais
// (Klein, Lacan, Winnicott...), vale conferir e aprofundar contra o texto.
...
const psicanaliseTemas = [
  ...
  },
  {
    ...
    intro:'Élisabeth Roudinesco (1944-) é historiadora e psicanalista, biógrafa de Lacan e de Freud. Sua contribuição não é uma técnica: é a consciência histórica e crítica do próprio campo — saber de onde vem o que se pratica, e o que se disputa hoje em torno disso.',
    itens:[
