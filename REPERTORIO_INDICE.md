...
| (protótipos movidos p/ `01_Codigo/prototipos/`) | — |
...
Logos, recomendações-exemplo, Triagrama, escala emocional, cupom, `obrasV4/` (screenshots do MMObras).

## 🗄️ 21_Backups/ — backups e arquivos comprimidos
JSONs de backup, .zip, `backup_antigo/` (backups 06/2026), versão antiga do protótipo da Árvore.
